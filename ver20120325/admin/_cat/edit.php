...
?>
			...
			<div id="edit">
				<h3><?php echo $page_title; ?> categoría</h3>
				...
				<form id="data" name="data" action="<?php echo $actions_page; ?>" method="post">
					<div class="left">
						...
						<ul>
							<li class="title"><label for="nombre">Categoria</label></li>
							...
							<li class="title"><label for="color">Color (hexadecimal)</label></li>
							<li><input class="required rounded title" type="text" name="color" id="color" value="<?php echo $row_content->color; ?>" tabindex="30" /></li>
						...
						<input type="hidden" name="action" id="action" value="<?php echo $action; ?>_cat" />
