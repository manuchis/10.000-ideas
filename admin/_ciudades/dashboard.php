...
?>
			...
			<!-- selections -->
				<div class="actions rounded">
					<a class="add-button left" href="<?php echo $edit_page; ?>">Nueva ciudad</a>
			...
			<form id="list" name="list" action="<?php echo $actions_page; ?>" method="post">
				<table class="tablesorter" id="sorter">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo utf8_decode($row_content->pais)." (".$row_content->paisid.")"; ?></td>
				...
				<input type="hidden" id="action" name="action" value="delete_ciudad" />
